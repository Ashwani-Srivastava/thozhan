                ...
                <div id="rev_slider_1078_1" class="rev_slider fullwidthabanner" style={{ 'display': 'none' }} data-version="5.4.1">
                    <ul>
                        ...
                        {this.obj.photos.slice(0,3).map(s =>(
                            <li data-index="rs-3049" data-transition="zoomin" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb={s}  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="" >
                            { /** MAIN IMAGE  */ }
            ...
            <div class="container">
                ...
                { this.obj.projects.slice(0, 3) .map(p => (
                             ...
                             <div class="single-causes">
                                 <img src={p.photo.url} alt="image" class="img-responsive image-resize2"/ >
                                 <div class="icon">
                            ...
                            <div class="col-lg-3">
                                <div class="testimonials-info">
                                    ...
                                    <ul class="social-info">
                                        {Array.apply(null, { length: s.rating }).map((e, i) => (
                                        <li >
                                        <i class='bx bxs-star' key={i}></i>
                                    </li>
                                        ))}
                                        {/* <li >
                ...
                <div class="row justify-content-md-around">
                    {this.obj.media.slice(0,3).map(s=>(
                        ...
                        <div class="single-blog">
                            ...
                            <img src={s.photo.url} alt="image" class="image-resize"/>
                            {/* </div>  */}
                            <div class="content">
                                <a href={s.link}>
